import { calculateResult, A, B, C, D, E, F, X, Y, } from "./main.js";
export const breakData = (text) => {
    try {
        text = text.trim();
        if (text === "") {
...
export const addMultiplySign = (text) => {
...
export function replaceTrigFunction(text, functionName, mathFunction) {
...
export const variableMultiplyAdder = (variable, text) => {
    let variableValue = "";
    if (variable === "A") {
        variableValue = A;
    }
